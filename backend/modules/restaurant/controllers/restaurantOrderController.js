...
export const getRestaurantOrders = asyncHandler(async (req, res) => {
  try {
    ...
    const projection = 'orderId userId items pricing payment status address createdAt deliveredAt eta preparationTime note sendCutlery review deliveryPartnerId assignmentInfo deliveryState';

...
async function verify() {
  try {
    ...
    const mockAddressShort = {
      location: {
        coordinates: [77.2190, 28.6139]
      }
    }; // ~1km away
    const mockAddressFar = {
      location: {
        coordinates: [77.3090, 28.6139]
      }
    }; // ~10km away
    ...
    if (settlementSub.restaurant.commission === 0) {} else console.error("❌ Commission charged for Subscription model!");

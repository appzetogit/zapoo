...
export default function RestaurantConfigPage() {
  ...
  const ToggleSwitch = ({
    ...
    scale: 0.95
  }} onClick={() => onChange(!enabled)} className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 ${enabled ? "bg-blue-600" : "bg-gray-300"}`}>
      <motion.span animate={{
      x: enabled ? 24 : 4
    }} transition={{
      type: "spring",
  ...
  return <div className="min-h-screen bg-gray-50 pb-20 md:pb-6">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          scale: 0.9
        }} onClick={() => navigate(-1)} className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-4">
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input type="number" step="0.1" value={minOrderAmount} onChange={e => setMinOrderAmount(e.target.value)} className="flex-1" />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input type="text" value={cuisineInput} onChange={e => setCuisineInput(e.target.value)} onKeyPress={e => e.key === "Enter" && addCuisine()} placeholder="Add cuisine" className="mb-2" />
                  <div className="flex flex-wrap gap-2">
                    {cuisines.map((cuisine, index) => <span key={index} className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 rounded-full text-sm">
                        {cuisine}
                        <motion.button whileHover={{
                      scale: 1.2
                    }} whileTap={{
                      scale: 0.9
                    }} onClick={() => removeCuisine(index)} className="hover:text-red-500">
                          <X className="w-4 h-4" />
                        </motion.button>
                      </span>)}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-2">
                    <Input type="text" value={characteristicInput} onChange={e => setCharacteristicInput(e.target.value)} onKeyPress={e => e.key === "Enter" && addCharacteristic()} placeholder="Add characteristic" className="flex-1" />
                    <Button onClick={addCharacteristic} className="bg-blue-500 hover:bg-blue-600 text-white px-4">
                      <Plus className="w-4 h-4" />
                    </Button>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {characteristics.map((char, index) => <span key={index} className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 rounded-full text-sm">
                        {char}
                        <motion.button whileHover={{
                      scale: 1.2
                    }} whileTap={{
                      scale: 0.9
                    }} onClick={() => removeCharacteristic(index)} className="hover:text-red-500">
                          <X className="w-4 h-4" />
                        </motion.button>
                      </span>)}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-2">
                    <Input type="text" value={tagInput} onChange={e => setTagInput(e.target.value)} onKeyPress={e => e.key === "Enter" && addTag()} placeholder="Add tag" className="flex-1" />
                    <Button onClick={addTag} className="bg-blue-500 hover:bg-blue-600 text-white px-4">
                      <Plus className="w-4 h-4" />
                    </Button>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {tags.map((tag, index) => <span key={index} className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 rounded-full text-sm">
                        {tag}
                        <motion.button whileHover={{
                      scale: 1.2
                    }} whileTap={{
                      scale: 0.9
                    }} onClick={() => removeTag(index)} className="hover:text-red-500">
                          <X className="w-4 h-4" />
                        </motion.button>
                      </span>)}
                  </div>
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={foodType.veg} onChange={e => setFoodType({
                      ...foodType,
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" checked={foodType.nonVeg} onChange={e => setFoodType({
                      ...foodType,
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input type="number" step="0.1" value={gstAmount} onChange={e => setGstAmount(e.target.value)} className="flex-1" />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="chargeType" value="optional" checked={chargeType === "optional"} onChange={e => setChargeType(e.target.value)} className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-600" />
                      <span className="text-sm md:text-base text-gray-700">Optional</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="radio" name="chargeType" value="mandatory" checked={chargeType === "mandatory"} onChange={e => setChargeType(e.target.value)} className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-600" />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input type="number" step="0.1" value={extraPackagingAmount} onChange={e => setExtraPackagingAmount(e.target.value)} className="flex-1" />
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        ease: [0.4, 0, 0.2, 1]
          ...
          <Card>
            <CardContent className="p-4 md:p-6">
              ...
              <div className="space-y-4">
                {days.map(day => <div key={day.key} className="space-y-2">
                    <label className="block text-sm md:text-base font-medium text-gray-700">{day.label}</label>
                    {schedule[day.key].map((slot, index) => <div key={index} className="flex items-center gap-2">
                        <Input type="text" value={`${slot.start} - ${slot.end}`} readOnly className="flex-1" />
                        <motion.button whileHover={{
                    scale: 1.1
                  }} whileTap={{
                    scale: 0.9
                  }} onClick={() => removeTimeSlot(day.key, index)} className="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors">
                          <X className="w-4 h-4" />
                        </motion.button>
                      </div>)}
                    <Button onClick={() => addTimeSlot(day.key)} className="bg-blue-500 hover:bg-blue-600 text-white" size="sm">
        ...
        ease: [0.4, 0, 0.2, 1]
          ...
          scale: 0.98
            ...
            <Button onClick={() => {}} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 md:py-4 rounded-lg text-base md:text-lg">
              Update
            </Button>
          </motion.div>
        </motion.div>

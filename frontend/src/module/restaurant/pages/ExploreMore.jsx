...
import { ArrowLeft, Search, User, UserRound, Store, ChevronRight, Info, Clock, Users, Settings, Bell, Truck, FileText, Star, MessageSquare, HelpCircle, Lightbulb, Edit, IndianRupee, Receipt, FileCheck, Building2, X, CheckCircle, Calendar, MapPin, Zap, Utensils } from "lucide-react";
...
function TimePickerWheel({
  ...
  const handleScroll = (container, setValue, values, itemHeight) => {
    ...
    const index = Math.round((containerCenter - padding - itemCenterOffset) / itemHeight);
      ...
      opacity: 0
        ...
        stiffness: 300
          ...
          <div className="flex items-center justify-center py-8 px-4 relative">
            ...
            }} onScroll={() => handleScroll(hourRef.current, setSelectedHour, hours, 40)} onTouchEnd={() => snapToCenter(hourRef.current, setSelectedHour, hours, 40)}>
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              scrollBehavior: 'smooth',
              WebkitOverflowScrolling: 'touch'
            }} onScroll={() => handleScroll(minuteRef.current, setSelectedMinute, minutes, 40)} onTouchEnd={() => snapToCenter(minuteRef.current, setSelectedMinute, minutes, 40)}>
                <div className="h-20"></div>
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              scrollBehavior: 'smooth',
              WebkitOverflowScrolling: 'touch'
            }} onScroll={() => handleScroll(periodRef.current, setSelectedPeriod, periods, 40)} onTouchEnd={() => snapToCenter(periodRef.current, setSelectedPeriod, periods, 40)}>
                <div className="h-20"></div>
...
export default function ExploreMore() {
  ...
  const scheduleOffReasons = ["renovation or relocation of restaurant", "closed dur to festival", "permanently shut", "staff avaibility issues", "going out of station", "other"];
    ...
    ease: [0.25, 0.1, 0.25, 1]
      ...
      <AnimatePresence>
        {scheduleOffOpen && <>
          ...
          duration: 0.2
        }} className="fixed inset-0 bg-black/50 z-50" onClick={() => setScheduleOffOpen(false)} />
          ...
          stiffness: 300
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                ...
                <button onClick={() => setScheduleOffOpen(false)} className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Close">
                  <X className="w-5 h-5 text-gray-900" />
                </button>
              </div>
              ...
              <div className="px-6 py-4">
                {scheduleOffReasons.map((reason, index) => <button key={index} onClick={() => handleReasonSelect(reason)} className="w-full text-left py-4 px-4 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-b-0">
      ...
      <AnimatePresence>
        {dateTimePickerOpen && <>
          ...
          duration: 0.2
        }} className="fixed inset-0 bg-black/50 z-50" onClick={() => setDateTimePickerOpen(false)} />
          ...
          stiffness: 300
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                ...
                <button onClick={() => setDateTimePickerOpen(false)} className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Close">
                  <X className="w-5 h-5 text-gray-900" />
                </button>
              </div>
              ...
              <div className="px-6 py-6 space-y-6">
                {/* Selected Reason */}
                {selectedReason && <div className="pb-4 border-b border-gray-200">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <button onClick={() => setShowCalendar(true)} className="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <button onClick={() => setShowStartTimePicker(true)} className="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <div>
                      ...
                      <button onClick={() => setShowEndTimePicker(true)} className="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                ...
                {/* Submit Button */}
                <button onClick={handleSubmitScheduleOff} className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors mt-4">
                  Submit
                </button>
              </div>
            </motion.div>
      ...
      {/* Calendar Popup */}
      {showCalendar && <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4" onClick={() => setShowCalendar(false)}>
          <div onClick={e => e.stopPropagation()} className="bg-white rounded-lg shadow-lg">
            <DateRangeCalendar startDate={startDate} endDate={endDate} onDateRangeChange={handleDateRangeChange} onClose={() => setShowCalendar(false)} />
          </div>
        </div>}

      {/* Start Time Picker */}
      <TimePickerWheel isOpen={showStartTimePicker} onClose={() => setShowStartTimePicker(false)} initialHour={startTime.hour} initialMinute={startTime.minute} initialPeriod={startTime.period} onConfirm={handleStartTimeConfirm} />

      {/* End Time Picker */}
      <TimePickerWheel isOpen={showEndTimePicker} onClose={() => setShowEndTimePicker(false)} initialHour={endTime.hour} initialMinute={endTime.minute} initialPeriod={endTime.period} onConfirm={handleEndTimeConfirm} />
      ...
      <AnimatePresence>
        {successPopupOpen && <>
          ...
          opacity: 0
        }} onClick={() => setSuccessPopupOpen(false)} className="fixed inset-0 bg-black/50 z-[10000]" />
          ...
          damping: 25,
          stiffness: 300
        }} className="fixed inset-0 flex items-center justify-center z-[10000] px-4" onClick={e => e.stopPropagation()}>
      ...
      <AnimatePresence>
        {existingScheduleOpen && existingSchedule && <>
          ...
          duration: 0.2
        }} className="fixed inset-0 bg-black/50 z-50" onClick={() => setExistingScheduleOpen(false)} />
          ...
          stiffness: 300
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                <h2 className="text-lg font-bold text-gray-900">Schedule off</h2>
                <button onClick={() => setExistingScheduleOpen(false)} className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Close">
                  <X className="w-5 h-5 text-gray-900" />
                </button>
              </div>

            ...
            <CardContent className="p-4 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden bg-gray-100 border border-gray-200">
                  <img src={reviewData.productImage} alt={reviewData.productName} className="w-full h-full object-cover" onError={e => {
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => <Star key={i} className={`w-4 h-4 ${i < reviewData.rating ? "fill-[#ff8100] text-[#ff8100]" : "text-gray-300"}`} />)}
                  </div>
                </div>
              </div>
        ...
        delay: 0.1
          ...
          <Card className="bg-white shadow-sm border border-gray-100">
            <CardContent className="p-4">
              <Textarea value={replyText} onChange={e => setReplyText(e.target.value)} placeholder="Write your reply..." className="w-full min-h-[120px] bg-orange-50 border-orange-200 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-[#ff8100] focus:border-[#ff8100] resize-none" rows={5} />
            </CardContent>
          </Card>
        </motion.div>
      </div>

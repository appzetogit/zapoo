...
export default function MenuDiscountTiming() {
  ...
  const isFormValid = customerGroup && offerDays && startDate && targetMealtime && (discountType === "percentage-menu" && discountCards && discountCards.length > 0 || discountType === "flat-price-menu" && priceCards && priceCards.length > 0 || discountType === "bogo-menu" && discountConstruct && selectedItems && selectedItems.length > 0);
  const handlePreview = () => {
  ...
  return <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate(getBackPath())} className="p-1 rounded-full hover:bg-gray-100">

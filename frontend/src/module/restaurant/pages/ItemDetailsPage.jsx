            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                {recommendationStatus !== 'none' && (
                  <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${recommendationStatus === 'approved' ? 'bg-green-100 text-green-700' :
                    recommendationStatus === 'pending' ? 'bg-yellow-100 text-yellow-700' :
              ...
              <Switch
                checked={isRecommendationRequest}
                onCheckedChange={setIsRecommendationRequest}
                disabled={recommendationStatus === 'approved'}
                className="data-[state=unchecked]:bg-gray-300"
              />
            </div>

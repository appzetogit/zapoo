...
export default function ManageOutlets() {
  ...
  const options = ["Timings", "Contacts", "FSSAI Food License", "Bank account details", "Profile picture", "Name, address, location", "Ratings, reviews", "Delivery area changes"];
      ...
      <div className="flex-1 px-4 pt-4">
        ...
        <div className="bg-white rounded-lg border">
          ...
          <div className="divide-y divide-gray-200 ">
            {options.map((option, idx) => <button key={option} onClick={() => handleOptionClick(option)} className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50 transition-colors">

        ...
        <div className="">
          ...
          <div className="flex pl-4 relative items-center gap-2 overflow-x-auto pb-2" ref={scrollContainerRef} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            ...
            <button
              ...
              className="sticky right-0 z-10 bg-[#3B82F6] p-2 text-white border-2 border-[#3B82F6] flex items-center gap-2 px-2 py-1 text-semibold rounded-l-lg text-sm font-medium whitespace-nowrap"
            >
          ...
          <div className="px-4">
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#3B82F6] hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
              >
        ...
        {isFilterOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl z-[100] max-h-[85vh] flex flex-col"
            ...
            >
                  ...
                  {filterOptions.map((filter, index) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        className="w-5 h-5 text-[#3B82F6] border-gray-400 focus:ring-[#3B82F6]"
              ...
              <div className="px-4 py-4 border-t border-gray-200 space-y-2">
                ...
                <button
                  onClick={() => setIsFilterOpen(false)}
                  className="w-full py-3 rounded-lg font-semibold text-sm bg-[#3B82F6] text-white hover:bg-blue-700 transition-colors"
                >
                  Confirm
                </button>
              </div>
                        ...
                        {option.id === "custom" && availabilityReason === "custom" && (
                          <div className="ml-8 mt-2 mb-4">
                            <input
                              ...
                              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3B82F6] focus:border-[#3B82F6]"
                              required
                            />
                          </div>
                        )}
      ...
      <div className="fixed right-4 bottom-28 z-[60] flex flex-col gap-1">
        ...
        {activeTab !== "add-ons" && (
          <motion.button
            ...
            className="px-4 py-2 border bg-[#3B82F6] text-white border-[#3B82F6] rounded-lg text-sm font-bold"
          >
            + ADD
          </motion.button>)}
        ...
        {isCategoryOptionsOpen && selectedCategory && (
          <>
            ...
            <motion.div
              ...
              exit={{ y: "100%" }}
              transition={{ type: "spring", damping: 30, stiffness: 300 }}
              className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl z-[70] max-h-[50vh] flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
        ...
        {isEditCategoryOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ y: "100%" }}
              transition={{ type: "spring", damping: 30, stiffness: 300 }}
              className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl z-[70] max-h-[40vh] flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
        ...
        {isSearchOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ y: "100%" }}
              transition={{ type: "spring", damping: 30, stiffness: 300 }}
              className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl z-[70] max-h-[90vh] flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <label
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#3B82F6] hover:bg-blue-50 transition-colors"
                  >
              ...
              <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-[#3B82F6] text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center gap-2"
                >

    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Name"
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#DC2626] focus:border-transparent"
              />
      ...
      >
        <div className="py-6 flex flex-col items-center gap-4">
          {/* Success Icon */}
          <div className="w-12 h-12 bg-[#DC2626] rounded-full flex items-center justify-center shrink-0">

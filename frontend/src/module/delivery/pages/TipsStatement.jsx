            ...
            <div className="flex flex-col gap-2 mb-6">
              <div className="bg-white rounded-lg p-4 shadow-md border border-gray-200 w-64">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#DC2626] rounded mt-1"></div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`w-2 h-2 rounded ${index % 3 === 0 ? 'bg-[#DC2626]' :
                  ...
                  <div className="text-[#DC2626] text-sm font-medium">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="relative shrink-0 scale-75">
              <svg width="80" height="80" viewBox="0 0 80 80" className="shrink-0">
                {/* Outer circle */}
                <circle cx="40" cy="40" r="38" fill="white" stroke="#DC2626" strokeWidth="2" />
                {/* Checkmark */}
                <path d="M 25 40 L 35 50 L 55 30" stroke="#DC2626" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                {/* Circular text path */}
                <defs>
                  <path id="tipCircle" d="M 40,40 m -30,0 a 30,30 0 1,1 60,0 a 30,30 0 1,1 -60,0" fill="none" />
                </defs>
                <text fill="#DC2626" fontSize="7" fontWeight="600" letterSpacing="0.5">

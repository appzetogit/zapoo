...
export default function DeliveryOTP() {
  ...
  const handleVerify = async (otpValue = null) => {
    ...
    try {
      ...
      const message = err?.response?.data?.message || err?.response?.data?.error || err?.message || "Failed to verify OTP. Please try again.";
      setError(message);
      setIsLoading(false);
    }
  };
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      const message = err?.response?.data?.message || err?.response?.data?.error || err?.message || "Failed to resend OTP. Please try again.";
      setError(message);
    } finally {
      setIsLoading(false);
    }

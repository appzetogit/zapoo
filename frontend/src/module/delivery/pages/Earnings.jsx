...
export default function Earnings() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Header */}
      <div className="bg-[#DC2626] text-white px-4 py-4 flex items-center justify-between">
        <button
          onClick={() => navigate(-1)}
      ...
      {/* Tabs */}
      <div className="bg-[#DC2626] px-4 flex flex-col gap-2 border-b rounded-b-xl border-white">
                  ...
                  return (
                    <div key={index} className="flex-1 flex flex-col items-center gap-1.5">
                      ...
                      <div className="w-full flex flex-col items-center justify-end relative" style={{ height: '120px' }}>
                        {hasEarnings ? (
                          <div
                            className="w-full bg-[#DC2626] rounded-t transition-all"
                            style={{

    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-4 flex gap-3">
        <button
          ...
          className={`relative flex-1 py-3 px-4 rounded-lg font-medium transition-colors ${activeTab === "in-progress"
        ...
        <button
          ...
          className={`relative flex-1 py-3 px-4 rounded-lg font-medium transition-colors ${activeTab === "past"
            ? "bg-[#DC2626] text-white"
            : "bg-white text-gray-900 border border-gray-200"
            }`}
        >
              ...
              inProgressReferrals.map((referral, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium text-[#DC2626]">Pending</span>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 bg-[#DC2626] text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-[#B91C1C] transition-colors"
                      >

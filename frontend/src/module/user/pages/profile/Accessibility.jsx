    ...
    <AnimatedPage className="min-h-screen bg-[#f5f5f5] dark:bg-[#0a0a0a]">
      <div className="max-w-md md:max-w-2xl lg:max-w-3xl mx-auto px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8">
        ...
        <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6 lg:mb-8">
          ...
          <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-black dark:text-white">{t("user.accessibility.title")}</h1>
        </div>
            ...
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-base md:text-lg lg:text-xl font-semibold text-gray-900 dark:text-white mb-1 md:mb-2">
                  {t("user.accessibility.hero.title")}
                </h3>
                <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">
                  {t("user.accessibility.hero.description")}
                </p>
              </div>
            </div>
          </CardContent>
                ...
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    <Label className="text-base md:text-lg font-medium text-gray-900 dark:text-white">
                      {t("user.accessibility.options.largeText.label")}
                    </Label>
                    <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">
                      {t("user.accessibility.options.largeText.description")}
                    </p>
                  </div>
                </div>
                <Switch
            ...
            <CardContent className="p-4 md:p-5 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    <Label className="text-base md:text-lg font-medium text-gray-900 dark:text-white">
                      {t("user.accessibility.options.highContrast.label")}
                    </Label>
                    <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">
                      {t("user.accessibility.options.highContrast.description")}
                    </p>
                  </div>
                </div>
                <Switch
            ...
            <CardContent className="p-4 md:p-5 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    <Label className="text-base md:text-lg font-medium text-gray-900 dark:text-white">
                      {t("user.accessibility.options.screenReaderSupport.label")}
                    </Label>
                    <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">
                      {t("user.accessibility.options.screenReaderSupport.description")}
                    </p>
                  </div>
                </div>
                <Switch
            ...
            <CardContent className="p-4 md:p-5 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    <Label className="text-base md:text-lg font-medium text-gray-900 dark:text-white">
                      {t("user.accessibility.options.reduceMotion.label")}
                    </Label>
                    <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">
                      {t("user.accessibility.options.reduceMotion.description")}
                    </p>
                  </div>
                </div>
                <Switch

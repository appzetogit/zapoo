      ...
      <header className="sticky top-0 z-50 bg-[#D66B3A] border-b border-[#C56235] shadow-sm">
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onMenuClick}
              className="lg:hidden p-2 rounded-md text-white hover:bg-white/20 hover:text-white transition-colors"
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="relative p-2 rounded-md text-white hover:bg-white/20 hover:text-white transition-colors">
                  <MessageCircle className="w-5 h-5" />
                  {messages.filter((m) => m.unread).length > 0 && (
                    <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-white text-[#FF5200] text-[10px] rounded-full flex items-center justify-center font-bold px-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="flex items-center gap-2 pl-3 border-l border-white/20 cursor-pointer hover:bg-white/10 rounded-md px-2 py-1 transition-colors">

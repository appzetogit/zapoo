...
import {
    ...
    Megaphone, AlertCircle, Image as ImageIcon
} from 'lucide-react';
...
export default function AdminNotificationRequests() {
    ...
    const [imagePreviewModal, setImagePreviewModal] = useState(null); // { url, title }
                                ...
                                <table className="w-full">
                                    <thead className="bg-slate-50 border-b border-slate-200">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 text-center text-xs font-bold text-slate-600 uppercase tracking-wider">Image</th>
                                            ...
                                            return (
                                                <tr key={req._id} className="hover:bg-slate-50 transition-colors">
                                                    ...
                                                    <td className="px-4 py-4 text-center">
                                                        {req.imageUrl ? (
                                                            <button
                                                                onClick={() => setImagePreviewModal({ url: req.imageUrl, title: req.title })}
                                                                className="inline-flex items-center justify-center p-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-all"
                    ...
                    >
                        <div className="p-4 border-b border-slate-200">
                            <h3 className="text-base font-semibold text-slate-900 truncate">
                                {imagePreviewModal.title || 'Submitted Image'}
                            </h3>
                        </div>
                        <div className="p-4 bg-slate-50">
                            <img
                                src={imagePreviewModal.url}
                                alt={imagePreviewModal.title || 'Submitted notification image'}

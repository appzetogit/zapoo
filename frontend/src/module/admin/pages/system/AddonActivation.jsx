...
export default function AddonActivation() {
  const [addonStates, setAddonStates] = useState(addons.reduce((acc, addon) => {
  ...
  return <div className="p-2 lg:p-3 bg-slate-50 min-h-screen">
      <div className="w-full mx-auto max-w-5xl">
        ...
        <div className="space-y-3">
          {addons.map(addon => <div key={addon.id} className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {addon.hasSettings && <button type="button" onClick={() => handleSettings(addon.id)} className="p-1.5 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded transition-colors">

...
export default function AnalyticsScript() {
  const [toolStates, setToolStates] = useState(marketingTools.reduce((acc, tool) => {
    acc[tool.id] = false;
    return acc;
  }, {}));
  ...
  return <div className="p-2 lg:p-3 bg-slate-50 min-h-screen">
      <div className="w-full mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          {marketingTools.map(tool => <div key={tool.id} className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
              <div className="mb-3">

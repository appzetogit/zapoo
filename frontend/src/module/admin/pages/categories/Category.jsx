  ...
  const handleExportPDF = () => {
    try {
      ...
      autoTable(doc, {
        ...
        theme: 'striped',
        headStyles: {
          fillColor: [255, 82, 0], // Orange color
          textColor: 255,
          fontStyle: 'bold',
          fontSize: 10
        },
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="px-4 py-2.5 text-sm font-medium rounded-lg bg-orange-600 text-white hover:bg-orange-700 flex items-center gap-2 transition-all shadow-sm"
            >

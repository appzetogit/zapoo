  ...
  if (!zone) {
    return <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate("/admin/zone-setup")} className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
            Back to Zones
          </button>
        </div>
      </div>;
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {zone.coordinates && zone.coordinates.length > 0 && <div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              ...
              minHeight: "600px"
                ...
                {mapLoading && <div className="absolute inset-0 flex items-center justify-center bg-slate-100 rounded-lg" style={{
                zIndex: 10,
                pointerEvents: "none"
              }}>
                    <div className="text-center">
                ...
                {!googleMapsApiKey && !mapLoading && <div className="absolute inset-0 flex items-center justify-center bg-slate-100 rounded-lg" style={{
                zIndex: 10
              }}>

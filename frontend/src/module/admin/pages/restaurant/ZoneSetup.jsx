      ...
      <div className="w-full mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#FF5200] text-white rounded-lg hover:bg-[#E64A00] transition-colors"
            >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#FF5200] focus:border-[#FF5200]"
            />
          </div>
        </div>
        ...
        {loading ? (
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#FF5200] mx-auto mb-4"></div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-12 text-center">
            ...
            {!searchQuery && (
              <button
                onClick={() => navigate("/admin/zone-setup/add")}
                className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF5200] text-white rounded-lg hover:bg-[#E64A00] transition-colors"
              >
                <Plus className="w-5 h-5" />
                <span>Add Zone</span>
              </button>
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2 text-slate-600 hover:text-[#FF5200] hover:bg-orange-50 rounded-lg transition-colors"
                      title="View"
                    >

...
export const API_ENDPOINTS = {
  ...
  DELIVERY: {
    ...
    ORDER_VERIFY_HANDOFF_OTP: "/delivery/orders/:orderId/verify-handoff-otp",
    ORDER_RESEND_HANDOFF_OTP: "/delivery/orders/:orderId/resend-handoff-otp",
    ORDER_SIMULATE_ROUTE: "/delivery/orders/:orderId/simulate-route",

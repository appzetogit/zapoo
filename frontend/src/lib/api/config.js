...
export const API_ENDPOINTS = {
  ...
  RESTAURANT: {
    AUTH: {
      ...
      NATIVE_GOOGLE_LOGIN: "/restaurant/auth/google/native-login",
  ...
  DELIVERY: {
    ...
    ORDER_COLLECT_QR: "/delivery/orders/:orderId/collect/qr",
    ORDER_PAYMENT_STATUS: "/delivery/orders/:orderId/payment-status",
    ORDER_COLLECT_CASH: "/delivery/orders/:orderId/collect/cash",
    ...
    CASH_LIMIT: "/delivery/cash-limit",
    POCKET_DETAILS: "/delivery/pocket-details",
    EARNING_ADDONS_ACTIVE: "/delivery/earning-addons/active",
    REFERRAL_STATS: "/delivery/referrals/stats",
  ...
  ADMIN: {
    ...
    SETTLEMENTS_ORDER: "/admin/settlements/order/:orderId",
    ...
    OFFERS: "/admin/offers",
    CUSTOMER_COUPONS: "/admin/customer-coupons",
    CUSTOMER_COUPON_BY_ID: "/admin/customer-coupons/:id",
    CUSTOMER_COUPON_STATUS: "/admin/customer-coupons/:id/status",
    ZONES: "/admin/zones",
